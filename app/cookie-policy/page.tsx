      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="space-y-6 text-slate-300 leading-relaxed text-sm sm:text-base">
          ...
          <section className="space-y-3">
            ...
            <p>
              If you have any questions about our use of cookies, please contact us at <a href="mailto:inquiry@Anviaan.com" className="text-blue-400 hover:underline">inquiry@Anviaan.com</a>.
            </p>
          </section>
        </div>
