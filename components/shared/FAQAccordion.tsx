...
export default function FAQAccordion({
  ...
  badge = 'FAQ',
  contactEmail = 'inquiry@Anviaan.com',
}: FAQAccordionProps) {
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-14">
          ...
          <p className="mt-5 text-lg text-slate-500 leading-relaxed">{subtitle}</p>
        </div>
            ...
            return (
              <div
                ...
                className={`bg-white border rounded-2xl overflow-hidden transition-all duration-300 ${
                  isOpen ? 'border-blue-200 shadow-lg shadow-blue-500/8' : 'border-slate-100 hover:border-blue-100'
                }`}
              >
                <button
                ...
                >
                  ...
                  <span className={`font-semibold text-sm leading-relaxed transition-colors duration-200 ${isOpen ? 'text-blue-700' : 'text-slate-800'}`}>
                    {faq.question}
                  </span>
                </button>
                <div
        ...
        <div className="mt-12 p-6 bg-gradient-to-br from-blue-50 to-sky-50 border border-blue-100 rounded-3xl text-center">
          <p className="text-slate-700 font-medium mb-1">Still have a question?</p>
          <p className="text-sm text-slate-500 mb-4">We are happy to answer anything not covered here.</p>
          <a href={`mailto:${contactEmail}`} className="inline-flex items-center gap-2 text-sm font-bold text-blue-600 hover:text-blue-700 transition-colors">
            {contactEmail}
          </a>
        </div>
      </div>
