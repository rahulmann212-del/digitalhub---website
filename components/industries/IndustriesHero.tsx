  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        {/* Industry pills — quick jump at bottom */}
          ...
          <div className="flex flex-wrap gap-2.5">
            {sectorPills.map((sector) => (
              <button
                ...
                className="px-4 py-2 bg-white/90 backdrop-blur-sm border border-slate-200/90 rounded-xl text-xs sm:text-sm font-bold text-[#063A9A] hover:bg-orange-50 hover:border-orange-200 hover:text-[#FF6600] shadow-sm transition-all duration-300"
              >
                {sector.name}
              </button>
            ))}
