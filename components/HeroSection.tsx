...
const trustItems = [
  {
    ...
    desc: 'Pixel-perfect on every screen',
  ...
  },
  {
    icon: BarChart2,
    label: 'SEO Optimized',
    desc: 'Rank higher, reach further',
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-16">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            >
              Build Websites{' '}
              <span className="text-gradient block">That Grow Your</span>
              Business
            </h1>

            {/* Subheadline */}
            <p className="text-lg text-slate-500 leading-relaxed max-w-lg">
              We help startups and businesses establish a strong online presence
              through professional website development, SEO, and digital
              marketing that generates quality leads and long-term growth.
            </p>
          ...
          <div className="relative flex items-center justify-center">
            ...
            <div className="relative w-72 lg:w-96 glass rounded-3xl shadow-2xl shadow-blue-500/15 p-6 animate-float">
              ...
              <div className="flex items-center gap-1.5 mb-4">
                ...
                <div className="flex-1 ml-2 h-6 bg-slate-100 rounded-lg flex items-center px-2">
                  <span className="text-xs text-slate-400">https://yourbusiness.com</span>
                </div>
              </div>
              ...
              <div className="mt-4 space-y-2">
                <div className="flex items-center justify-between text-xs text-slate-500">
                  ...
                  <span className="text-green-500 font-semibold">+38%</span>
                </div>
            ...
            <div className="absolute -top-4 -left-4 lg:-left-8 glass rounded-2xl px-3 py-2 shadow-lg animate-float-delayed">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <div className="text-xs font-bold text-slate-700">SEO Score</div>
                  <div className="text-xs text-green-500 font-semibold">98/100</div>
                </div>
              </div>
            </div>
            ...
            <div className="absolute -bottom-4 -right-4 lg:-right-8 glass rounded-2xl px-3 py-2 shadow-lg animate-float-slow">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <div className="text-xs font-bold text-slate-700">Uptime</div>
                  <div className="text-xs text-blue-500 font-semibold">99.9%</div>
                </div>
              </div>
            </div>
          </div>
