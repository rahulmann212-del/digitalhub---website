  ...
  return (
    <>
      ...
      >
        ...
        {/* Ambient Glow */}
        <div className="absolute top-10 right-10 w-72 h-72 bg-blue-300/20 rounded-full blur-[80px] pointer-events-none" />
        <div className="absolute bottom-10 left-10 w-96 h-96 bg-orange-300/15 rounded-full blur-[80px] pointer-events-none" />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            {/* Right — Visible on Tablets and Desktops (hidden md:flex), hidden only on small mobile screens */}
            <div className="hidden md:relative md:flex items-center justify-center mt-12 lg:mt-0">
              ...
              <div className="relative w-[300px] sm:w-[340px] lg:w-[380px] bg-[#020b1e] rounded-3xl shadow-[0_20px_50px_rgba(6,58,154,0.15)] p-4 lg:p-6 border border-slate-700/50 hover:border-[#FF6600]/50 transition-colors duration-500 animate-float z-10">
                ...
                <div className="rounded-2xl overflow-hidden bg-gradient-to-br from-[#063A9A]/30 to-slate-900/80 p-4 border border-white/5 space-y-4">
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    {[
                      ...
                      <div key={i} className="bg-[#020816]/80 rounded-xl p-3 text-center border border-slate-700/50 hover:border-slate-500 transition-colors">
                  ...
                  <div className="bg-[#020816]/80 rounded-xl p-4 border border-slate-700/50">
                    ...
                    <div className="flex items-end gap-1.5 h-16 border-b border-slate-700/50 pb-1">
              ...
              <div className="absolute -top-4 -left-6 bg-white/95 backdrop-blur-md rounded-2xl px-4 py-3 shadow-xl border border-slate-200 animate-float-delayed z-20">
                <div className="flex items-center gap-3">
                  <div className="w-9 h-9 bg-green-100 rounded-lg flex items-center justify-center">
                    <TrendingUp className="w-4 h-4 text-green-600" />
                  </div>
                  <div>
                    <div className="text-xs font-bold text-slate-800">Monthly Sales</div>
                    <div className="text-xs text-green-600 font-semibold">Scaling Fast</div>
                  </div>
                </div>
              </div>
            </div>
