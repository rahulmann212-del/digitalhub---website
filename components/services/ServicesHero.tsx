...
export default function ServicesHero() {
  ...
  return (
    <>
      {/* Custom Animations for Smooth Entry */}
      ...
      >
        ...
        <div className="absolute right-8 lg:right-24 top-1/2 -translate-y-1/2 hidden lg:block pointer-events-none">
          <div className="relative w-48 h-48 animate-slide-right">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-16 h-16 bg-gradient-to-br from-[#063A9A] to-blue-600 rounded-3xl flex items-center justify-center shadow-xl shadow-blue-500/20 animate-float-icon">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full pt-6">
          {/* Breadcrumb */}
          <nav aria-label="Breadcrumb" className="flex items-center gap-2 text-sm text-slate-600 mb-6 font-medium animate-slide-up" style={{ animationDelay: '0ms' }}>
          ...
          <div className="max-w-2xl space-y-6">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-50 border border-blue-100 rounded-full text-sm font-bold text-[#063A9A] shadow-sm animate-slide-up" style={{ animationDelay: '100ms' }}>
            ...
            <h1
              ...
              className="text-3xl sm:text-4xl lg:text-5xl font-extrabold leading-[1.15] tracking-tight text-[#063A9A] animate-slide-up" style={{ animationDelay: '200ms' }}
            >
              Digital Solutions{' '}
            ...
            <p className="text-base lg:text-lg text-slate-700 leading-relaxed max-w-xl font-medium animate-slide-up" style={{ animationDelay: '300ms' }}>
            ...
            <div className="flex flex-wrap gap-4 pt-1 animate-slide-up" style={{ animationDelay: '400ms' }}>
              <Link
                href="/#contact"
          ...
          {/* Bottom info pills */}
          <div className="mt-10 flex flex-wrap gap-3 animate-slide-up" style={{ animationDelay: '500ms' }}>
            {[
